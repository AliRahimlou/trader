...
| Crypto opening range | Valid with at least **44** of 48 five-minute bars present between 00:00 and 04:00 ET; range from present bars. A missing later slot has no close and cannot start, confirm or invalidate an excursion; the latest expected slot must be present for a confirmation to be current. | Any missing bar voided the day. |
