...
POLICY = {
    ...
    'summary': [
        ...
        'The free data allowance has a durable request limit. Missing candles, delayed data, an exhausted allowance or an unsuccessful quote check blocks new entries. Each candle period permits an initial quote attempt and at most one bounded recovery or refresh within the shared allowance.',
